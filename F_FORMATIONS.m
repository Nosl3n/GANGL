...
hold on;
graficar_personas(X,y);
gaussiana_asimetrica_n_gdl(X,y,0, 0, 0, 0);
hold on;
...
hold on;
graficar_personas(X,y);
gaussiana_asimetrica_n_gdl(X,y,0, 0.1, 0.4, 0);
hold on;
gaussian2_a2_focussed(x1, y1, deg2rad(theta1) , 0.6, 0.3, 0.3, 0.1);
hold on;
gaussian2_a2_focussed(x2, y2, deg2rad(theta2) , 0.6, 0.3, 0.3, 0.1);
...
hold on;
graficar_personas(X,y);
gaussiana_asimetrica_n_gdl(X,y,0, 0.2, 0.2, 0.2);
hold on;
gaussian2_a2_focussed(x1, y1, deg2rad(theta1) , 0.6, 0.3, 0.3, 0.1);
hold on;
gaussian2_a2_focussed(x2, y2, deg2rad(theta2) , 0.6, 0.3, 0.3, 0.1);
...
hold on;
graficar_personas(X,y);
gaussiana_asimetrica_n_gdl(X,y,0.1, 0.2, 0, 0);
hold on;
gaussian2_a2_focussed(x1, y1, deg2rad(theta1) , 0.6, 0.3, 0.3, 0.1);
hold on;
gaussian2_a2_focussed(x2, y2, deg2rad(theta2) , 0.6, 0.3, 0.3, 0.1);
