function gaussian2_a2(mean_x, mean_y, rotation, variance_front, variance_right, variance_left, variance_rear)
limit = 2;
...
% contour(x,y,f,[0.1,0.1],'LineColor', 'b');
% hold on;
contour(x,y,f,[0.3,0.3],'LineColor', [0.5, 0.8, 1.0]);
hold on;
contour(x,y,f,[0.6,0.6],'LineColor', 'g');
hold on;
contour(x,y,f,[0.8,0.8],'LineColor', [1.0, 0.7, 0.3])
title('Curvas de Nivel');
%legend({'Zona personal', 'Zona social', 'Zona intima'});
% xlabel('x');
% ylabel('y');
% zlabel('f(x, y)');
